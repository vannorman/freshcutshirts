...
def render_md_blog(request):
    with open('fresh_cut_shirts/templates/blog/redefinelearning.md', 'rb') as fp:
        v = fp.read()
        v = md.convert(v)
        obj = {}
        obj['html_text'] = v
...
#	obj['social'] = [
#		{ "name" : "github.com/fresh_cut_shirts", "link" : "https://github.com/fresh_cut_shirts" },
#		{ "name" : "linkedin.com/in/fresh_cut_shirts", "link" : "https://www.linkedin.com/in/fresh_cut_shirts" },
#		{ "name" : "facebook.com/fresh_cut_shirts", "link" : "https://www.facebook.com/fresh_cut_shirts" },
#		{ "name" : "twitter.com/@fresh_cut_shirts", "link" : "https://twitter.com/@fresh_cut_shirts" },
#		{ "name" : "angel.co/supermathworld", "link" : "https://angel.co/supermathworld" },
#		{ "name" : "soundcloud.com/fresh_cut_shirts", "link" : "https://soundcloud.com/fresh_cut_shirts" },
#	]
